...
export default function UrlEncoder() {
  ...
  return (
    <ToolLayout title="URL 编解码" description="URL 编码和解码工具">
      <textarea value={input} onChange={e => setInput(e.target.value)} placeholder="输入文本或 URL..." rows={6} className="w-full rounded-lg p-3" style={inputStyle} />
