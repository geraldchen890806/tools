...
export default function RSAKeygenPage() {
  ...
  return (
    <ToolLayout title="RSA 密钥生成" description="使用 Web Crypto API 生成 RSA 密钥对（PEM 格式）">
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <label style={{ color: "var(--text-secondary)" }}>密钥长度</label>
        ...
        {pubKey && (
          <div className="space-y-2">
            <label className="font-medium" style={{ color: "var(--text-primary)" }}>公钥</label>
        ...
        {privKey && (
          <div className="space-y-2">
            <label className="font-medium" style={{ color: "var(--text-primary)" }}>私钥</label>
